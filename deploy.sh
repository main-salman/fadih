...
if ! mysql -u foi_user -pFoiArchive2024!SecureDB -e "USE foi_archive;" 2>/dev/null; then
    echo "🗄️ Setting up MySQL database..."
    mysql -e "CREATE DATABASE IF NOT EXISTS foi_archive;"
    mysql -e "CREATE USER IF NOT EXISTS 'foi_user'@'localhost' IDENTIFIED BY 'FoiArchive2024!SecureDB';"
